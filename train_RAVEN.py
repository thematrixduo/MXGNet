...
model_save_name = 'RAVEN_best.pt'
optimizer_save_name = 'RAVEN_best_opt.pt'
...
def main():
    parser = argparse.ArgumentParser(description='RAVEN train args')
    parser.add_argument('data', metavar='DIR',
                        help='path to dataset')
    parser.add_argument('--batch-size', type=int, default=64, metavar='N',
                        help='input batch size for training (default: 64)')
    parser.add_argument('--batch-size-val', type=int, default=32, metavar='N',
    ...
    model = Model(args.image_size,args.image_size,beta=0)
